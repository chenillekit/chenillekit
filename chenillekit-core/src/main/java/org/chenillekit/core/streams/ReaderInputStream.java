 ...
 * <p/>
 * stolen from org.apache.tools.ant.util.ReaderInputStream
 *
 */
public class ReaderInputStream extends InputStream {
     ...
     *
     * @exception java.io.IOException if the original <code>Reader</code> fails to be read
     */
     ...
     *
     * @exception java.io.IOException if the StringReader fails to be reset
     */
     ...
     *
     * @exception java.io.IOException if the original StringReader fails to be closed
     */
