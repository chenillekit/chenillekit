...
var Flotr = (function()
{
	...
	function Plot(container, data, opts)
	{
		...
		function constructCanvas()
		{
			...
			{
				canvasWidth = /\d+/.exec(target.getStyle('width'));
				canvasHeight = /\d+/.exec(target.getStyle('height'));
				if (canvasWidth <= 0 || canvasHeight <= 0)
				{
					alert('Invalid dimensions for plot, width = ' + canvasWidth + ', height = ' + canvasHeight);
