...
public class ChenilleKitAccessInternalUtilsTest extends TestBase
{
	...
	@Test
	public void required_groups_or_ok()
	{
		assertTrue(ChenillekitAccessInternalUtils.hasUserRequiredGroup(ALL, ADMINS, Logical.OR));
	}
	...
	@Test
	public void required_groups_or_ko()
	{
		assertFalse(ChenillekitAccessInternalUtils.hasUserRequiredGroup(USERS, ADMINS, Logical.OR));
	}
